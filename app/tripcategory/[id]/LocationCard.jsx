...
import ExploreBookingForm from "./ExploreBookingForm";
import Link from "next/link";

const LocationCard = ({ itineraryData, destination, packageData }) => {
  ...
  return (
    <div className="swiper-slide" style={{ cursor: show ? "default" : "pointer" }}>
      <div className="content-wrap">
        ...
        <div className="info">
          <span className="package">{formatDuration(itineraryData?.trip_durations || "")}</span>
          <Link
            href={`/itinerary/${itineraryData?.slug}`}
