...
const PackageInfo = ({ packageData, destination }) => {
        ...
        <div className="row">
          <div className="col-12">
            <div className="section-heading">
              ...
              {packageData?.itineraries?.length > 3 && 
              <a
            ...
            {!showGrid ? (
              <>
                <div className="swiper listing-content-swiper listing-content1-swiper">
                  ...
                  >
                    {packageData?.itineraries?.map((ele, index) => (
              ...
              <div className="itinerary-grid row swiper listing-content-swiper listing-content1-swiper">
                {packageData?.itineraries?.map((ele, index) => (
                  <div className="col-md-6 col-lg-4 col-sm-6 mb-2 px-1" key={index}>
                    <ItinerarySlider
                      itineraryData={ele}
                      destination={destination}
                      packageData={packageData}
